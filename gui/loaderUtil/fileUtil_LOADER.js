...
function removeLeadingDirectory(directoryPath) {
  const index = directoryPath.indexOf("/");
  if (index !== -1) {
    return directoryPath.slice(index);
  }
...
module.exports = {normalizeDirectoryPath, getDirectoriesRecursive, removeLeadingDirectory}